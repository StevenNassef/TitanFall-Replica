       ...
       //     m_CameraRefocus = new CameraRefocus(Camera, transform.root.transform, Camera.transform.localPosition);
        ...
        private void Update()
        {
          //  m_CameraRefocus.GetFocusPoint();
            ...
            {
                Camera.transform.localPosition = motionBob.DoHeadBob(titanFirstPersonController.Velocity.magnitude*(titanFirstPersonController.Running ? RunningStrideLengthen : 1f));
